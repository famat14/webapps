                                    ...
                                    <?php if ((1 == $clean_biz_feature_enable_title) || (1 == $clean_biz_feature_enable_caption)){?>
                                        <div class="banner-content-inner">
                                            <?php if( 1 == $clean_biz_feature_enable_title) {
                                                ?>
                                                    <h2 class="banner-title alt-title"><a href="javascript:void(0);<?php //echo esc_url( $clean_biz_slider_array['clean-biz-feature-slider-link'] );?>"><?php echo esc_html( $clean_biz_slider_array['clean-biz-feature-slider-title'] );?></a></h2>
                                                <?php
                                            }
                                            if( 1 == $clean_biz_feature_enable_caption){
                                                ...
                                                <?php if (!empty($clean_biz_feature_button_text)) { ?>
                                                    <div class="btn-holder">
                                                        <a href="javascript:void(0);<?php //echo esc_url( $clean_biz_slider_array['clean-biz-feature-slider-link'] );?>" class="button"><?php echo esc_html($clean_biz_feature_button_text); ?></a>
                                                    </div>
                                                <?php } ?>
                                                <?php
                                            }?>      
